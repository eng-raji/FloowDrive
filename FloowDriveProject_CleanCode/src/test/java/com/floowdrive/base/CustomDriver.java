...
import com.floowdrive.utilities.Utils;
...
public class CustomDriver {
	/** logs for lag4j intilization 
	 * 
	 * **/
	private static  org.apache.logging.log4j.Logger log = LogManager.getLogger(CustomDriver.class.getName());
  ...
  /**
   * constructor with prameter
   **/
    public CustomDriver(AppiumDriver<WebElement> driver) {
    ...
    public void refresh() {
       ...
       log.info("The Current Browser location was Refreshed...");
        Utils.sleep(3000, "The Current Browser location was Refreshed...");
    }
    ...
    public void elementClick(WebElement element, String info, long timeToWait) {
        try {
            ...
            if (timeToWait == 0) {
                ...
                Utils.sleep(timeToWait, "Clicked on :: " + info);
            }
        } catch (Exception e) {
    ...
    public void sendData(WebElement element, String data, String info, Boolean clear) {
        try {
            ...
            Utils.sleep(1000, "Waiting Before Entering Data");
